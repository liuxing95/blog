...
export default function PostCard({ post }: PostCardProps) {
  ...
  return (
    <article className="bg-white dark:bg-gray-800 rounded-lg shadow-md hover:shadow-lg transition-shadow duration-300 overflow-hidden group">
      <Link href={`/posts/${slug}`} className="block p-6 cursor-pointer">
        ...
        <div className="inline-flex items-center text-blue-600 dark:text-blue-400 group-hover:text-blue-800 dark:group-hover:text-blue-300 font-medium">
          阅读更多
          <svg
