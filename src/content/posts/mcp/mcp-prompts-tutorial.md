...
app = Server("code-assistant-server")
        ...
        return {
            ...
            "messages": [
                PromptMessage(
                    ...
                    content=TextContent(
                        type="text",
                        text=f"""Please perform a comprehensive code review for this {language} code.
...
5.  Recommendations"""
    ...
    error_message = arguments.get("error_message", "")
        ...
        return {
            "description": "Bug report generation",
            "messages": [
                PromptMessage(
                    role="user",
                    content=TextContent(
                        type="text",
                        text=f"""Generate a detailed bug report for this error:
...
"""读取 Resource 内容"""
    ...
    if uri == "resource://guidelines/code-review":
        return CODE_REVIEW_GUIDELINES
